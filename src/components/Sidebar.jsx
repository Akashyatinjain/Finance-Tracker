...
const Sidebar = () => {
  const linkClasses = ({ isActive }) =>
    `flex items-center gap-3 px-3 py-2 rounded-md transition font-medium
     ${isActive ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-white' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800'}`;
  ...
  return (
    <aside className="w-64 min-h-screen bg-gray-50 dark:bg-gray-950 p-4 border-r dark:border-gray-800 shadow-sm">
      <nav className="space-y-2">
        ...
        <NavLink to="/subscriptions" className={linkClasses}>
